const CACHE='tfd-v51-stable-2';
const CORE=['./','./index.html','./offline.html','./manifest.webmanifest','./search-live.js','./profile-context.js',
'./data/plants.json','./data/assessments.json','./data/korean_retail_name_map.json','./profile/','./meal/','./weekly/','./growth/','./monthly/','./trends/','./settings/'];
