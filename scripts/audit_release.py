...
evidence_files=["evidence.json","evidence_korea_addendum.json","evidence_korea_addendum_2.json","evidence_korea_addendum_3.json","evidence_korea_addendum_4.json"]
ev=set()
for fn in evidence_files:
  p=d/fn
  if p.exists(): ev.update(e["id"] for e in json.loads(p.read_text(encoding="utf-8")))
record_files=["nutrition_records.json","assessments.json","assessments_korea_addendum.json","assessments_korea_addendum_2.json","assessments_korea_addendum_3.json","assessments_korea_addendum_4.json","evidence_map.json","restrictions.json","explanations.json"]
