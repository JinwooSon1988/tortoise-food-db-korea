...
checks={
 ...
 'mallow_not_auto_parviflora':'Malva parviflora' in files['plant/mallow/index.html'] and '서로 다른 종' in files['plant/mallow/index.html'],
 ...
 'sowthistle_genus_evidence_limit':'Sonchus sp.' in files['plant/sowthistle/index.html'] and '종 수준 직접근거로 승격하지 않음' in files['plant/sowthistle/index.html'],
