...
checks={
 ...
 'sowthistle_genus_evidence_limit':'Sonchus sp.' in files['plant/sowthistle/index.html'] and ('종 수준 직접근거' in files['plant/sowthistle/index.html'] or '정확히 S. oleraceus' in files['plant/sowthistle/index.html']),
 ...
 'clover_genus_evidence_limit':'Trifolium sp.' in files['plant/clover/index.html'] and ('종 수준 직접근거' in files['plant/clover/index.html'] or '종 수준 직접근거로 바꾸지 않는다' in files['plant/clover/index.html']),
