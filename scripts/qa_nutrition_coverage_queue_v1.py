...
assert all(x["mapping_status"] in {"pending_source_file","identity_scope_hold","source_record_review","part_or_state_review","part_or_state_hold","not_listed_exact","cultivar_or_color_hold"} for x in q["records"])
print("OK")
