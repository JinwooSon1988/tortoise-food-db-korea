...
for i,r in enumerate(data.get("records",[])):
    ...
    if r.get("applicability")=="composition_only" and r.get("animal_taxon")!="not_applicable": errors.append(f"{label}: composition_only evidence must use animal_taxon=not_applicable")
