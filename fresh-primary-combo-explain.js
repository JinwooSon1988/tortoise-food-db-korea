(function(){
 ...
 const state={plants:[],assessments:[],evidence:[]};
 ...
 function sourceHTML(id){const e=linkedPrimarySource(id);if(!e)return '<div class="small fresh-source-missing">연결된 이베라 1차 출처 메타데이터 없음</div>';const href=sourceHref(e);return '<div class="fresh-primary-source"><div class="small"><b>연결된 이베라 1차 출처</b></div><div class="small">'+esc(e.citation||e.id)+'</div>'+(href?'<a href="'+esc(href)+'" target="_blank" rel="noopener noreferrer">원문/식별자 열기 ↗</a>':'<div class="small fresh-source-missing">공개 원문 링크/식별자 미등록</div>')+'</div>'}
 function renderExplain(){
  ...
  note.innerHTML='<div class="fresh-explain"><b>왜 이 3종을 골랐나</b>'+rows+'<div class="small fresh-explain-limit">각 출처는 해당 식물 판정에 이미 연결된 이베라 1차 야생섭식 자료 중 첫 번째 공개 메타데이터만 보여준다. 야생 관찰 빈도를 사육 급여비율로 환산하지 않으며, 이 설명은 급여량·배합률·영양완전성·건강효과를 계산하거나 보장하지 않는다.</div></div>';
 }
