(function(){
 ...
 window.fetch=async function(input,init){
  ...
  try{
   ...
   for(const suffix of ['_korea_addendum.json','_korea_addendum_2.json','_korea_addendum_3.json','_korea_addendum_4.json','_korea_addendum_5.json','_korea_addendum_6.json','_korea_addendum_7.json','_korea_addendum_8.json','_korea_addendum_9.json','_korea_addendum_10.json','_korea_addendum_11.json','_korea_addendum_12.json']){
    try{
